...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/favicon.ico?v=best-team-mark-v2-20260807", sizes: "48x48", type: "image/x-icon" },
        { url: "/favicon-96x96.png?v=best-team-mark-v2-20260807", sizes: "96x96", type: "image/png" },
        { url: `${SITE_LOGO_SQUARE}?v=best-team-mark-v2-20260807`, sizes: "512x512", type: "image/png" }
      ],
      apple: [{ url: "/apple-touch-icon.png?v=best-team-mark-v2-20260807", sizes: "180x180", type: "image/png" }],
      shortcut: ["/favicon.ico?v=best-team-mark-v2-20260807"]
    },
